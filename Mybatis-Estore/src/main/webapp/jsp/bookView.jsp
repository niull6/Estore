...
<body>
	...
	<div class="top">
		...
		<ul class="top_lr">		
				...
				<c:if test="${customer != null}">
					...
					<li><a href="LoginOutServlet" style="color: green;">退出登陆</a></li>
				</c:if>
			</ul>
			<ul class="top_bars">
	...
	<!--头部-->
	<div class="header3">
		<a href="jsp/index.jsp"><img src="images/logo.png"></a>
		<div class="h3_center">
	...
	<div class="container5">
		<div class="cn5_top">
			<div class="cn5_top_x center01">
				<a class="font20" href="#">书籍</a> > <a href="#">${book.category.name}</a>
			</div>
				...
				<div class="cn5topy_2">
					...
					<div class="pro_price">
						<div class="pro_price_x">
							<p>
							价&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;格:<b>￥${book.price }</b> <a href="#">(降价通知)</a>
							</p>
						</div>
					...
					<div class="pro_buy">
						...
						<div class="pro_addshop">
							<!-- 如果用户未登录，跳转至登录界面； 如果已登录，跳转至购物车界面 -->
							
							<c:if test="${customer==null}">
								<a href="jsp/login.jsp" onclick="alert('您尚未登录！请登陆！')">加入购物车</a>
							</c:if>
							
							<c:if test="${customer!=null}">
							<a href="AddShopCarServlet?id=${book.id }&num=1"
									onclick="addShopCart('${book.name}')">加入购物车 </a>
							</c:if>
						</div>
						</div>
					</div>
