		...
		<div class="contentCenter">
			<div class="centerTop">
				...
				<p style="font-size: 15px;">
					收件人姓名：<input type="text" id='addName' disabled name="name" value="${customer.name}"><br />
					<br /> 收件人地址：<input type="text" id='addAdd' disabled
						name="address" value="${customer.address}"><br /> <br /> 收件人电话：<input type="text"
						id='addPhone' disabled name="telephone" value="${customer.phone}">
				</p>
				<p style="font-size: 15px;">
					<button
			...
			<p class="singleP">
				<b>送货清单</b><span><a href="jsp/shopCar.jsp">返回修改购物车</a></span>
			</p>
			<div class="bigDiv">
				<div class="twoDiv">
					<b>商家：briup自营</b>
					<c:forEach items="${shopCar.lines}" var="line">
						<ul class="oneUL">
							<li><img src="images/viewBook.png" class="pic">
								<p>#类型名字&nbsp;&nbsp;${line.book.name}&nbsp;&nbsp;</p>
								<p>
									<font>${line.book.price}</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货
								</p>
								<p>
			...
			<div class="money">
				<span><font>${line.book.num}</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#购物车的总金额</span>
				<span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥0.00</span>

				<span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${(line.book.price)*(line.book.num)}</span>
			</div>
			<div class="submit">
				<span>应付金额：<font>${shop.getTotal()}</font>
				<a href="SubmitOrderServelt"><img src="images/21_03.png" alt=""></a>
				</span>
			</div>
		</div>
		...
		<div class="pop">
			...
			<div class="pop_con">
				<form class="info_list">
					<ul>
						<li><span class="name">收货人</span> <input name="name"
							type="text" id="addr_name" value="" maxlength="20"></li>
						<li><span class="name">手机号码</span> <input name="telephone"
				...
				<div class="btn_bar">
					<a href="javascript:void(0)" id="submitAdd" class="btn_red"
						onclick="addAddr()">确认新增收货地址</a> <a href="jsp/shopCar.jsp"
