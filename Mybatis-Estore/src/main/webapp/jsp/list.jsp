...
<body>
	...
	<!--头部-->
	<div class="header3">
		<a href="toIndexServlet"><img src="images/logo.png"></a>
		<div class="h3_center">
			<div class="search_box">
				<input type="text" /> <span>搜索</span>
			</div>
			<p>
				<c:forEach items="${categoryWithBooks }" var="categories" begin="0" end="4">
					<a href="ListServlet?id=${categories.id}">${categories.name }</a>|
				</c:forEach> 
			</p>
		</div>
		<div class="h3_right">
	...
	<div class="nav_top">
		<div class="nav_top_center">
			<div>全部图书分类</div>
			<ul>
				<c:forEach items="${categoryWithBooks }" var="categories">
					<li><a href="ListServlet?id=${categories.id }">${categories.name }</a></li>
				</c:forEach>
			</ul>
		</div>
	</div>
						...
						<li class="c4_b5_c_box">
							...
							<div class="c4_b5_c_box_pic">
								<div class="c4b5_pic_view">
									<a href="BookServlet?id=${book.id }"><img src="images/list_p1.png"></a>
								</div>
							</div> <!--价钱-->
							<div class="c4_b5_c_box_txt">
								<h1>￥ ${book.price }</h1>
								<h2>
									<a href="BookServlet?id=${book.id }">${book.name }</a>
								</h2>
							</div> <!--购买等操作-->
							<div class="c4b5_el">
								<div class="c4b5_el_x">
							...
							<ul class="c4b5_option">
								<li class="shopcar_box"><span class="shopcar01"></span><a
									href="javascript:void(0)" onclick="addShopCart('${book.name}')">加入购物车
								</a></li>
							</ul>
						</li>
					</c:forEach>
